...
/*AIC325x PLL*/
#define AIC325X_PLL_ID 3
#define AIC325X_PLL_MCLK 3
#define AIC325X_SYSCLK_FLL  2
...
#define AIC_HPDET_PIN  MX6SL_BRD_TLV320_HEADPHONE_DET
#define AIC_SPK_PIN 0
#define AIC_RESET_PIN MX6SL_BRD_AIC325X_RESET
...
//#define AP_GPIO_DET // use rk's gpio to detect insert
//#define IPHONE_HS_SUPPORT
//#define MICDET_IO_ASSIST

#ifdef IPHONE_HS_SUPPORT // iphone mic support
//#define AIC_HPEN_PIN   RK30_PIN2_PD5
#define AIC_HPEN_PIN  0/* RK30_PIN1_PB4*/
#else
#define AIC_HPEN_PIN   0
#endif
...
#endif
//int aic3256_probe(struct platform_device *pdev);
