...
static int csi_frame_count = 0;
static int csi_next_fb = 0;
...
{
	pr_debug("csi clock is switched to %s\n", flag ? "enable" : "disable");
	if (flag == g_csi_mclk_on)
		return 0;
...
EXPORT_SYMBOL(csi_mclk_disable);
