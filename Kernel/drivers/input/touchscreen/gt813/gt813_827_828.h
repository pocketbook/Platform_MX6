...
#define GTP_CHANGE_X2Y       1/*0 for myandroidr13.5-alpha,1 for  android-13.5.0-ga*/
...
#define GTP_RST_PORT    MX6SL_ARM2_GT813_RST/*RESET port */
#define GTP_INT_PORT    MX6SL_ARM2_GT813_INT
