...
WLM_FUNCTION
int wlmNvramVarGet(const char *varname, char *buff, int len);
...
/* Set transmit core
 * param[in] core number to be selected
 * return - True for success, false for failure.
 */
WLM_FUNCTION
 ...
 * param[out] chip core temperature in Fahrenheit
 * return - True for success, false for failure.
 */
WLM_FUNCTION
 ...
 * param[in] control values for each bit. 1 = enable/high, 0 = disable/low
*/
WLM_FUNCTION
