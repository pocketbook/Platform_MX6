...
///wen add
#define  MX6SL_GPIO_CTRL  (PAD_CTL_HYS | PAD_CTL_PKE | PAD_CTL_PUE | \
				PAD_CTL_PUS_47K_UP | PAD_CTL_DSE_DISABLE | PAD_CTL_SRE_FAST)

#define  MX6SL_GPIO_PUS100KUP_CTRL  (PAD_CTL_HYS | PAD_CTL_PKE | PAD_CTL_PUE | \
				PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_DISABLE | PAD_CTL_SRE_FAST)

#define  MX6SL_GPIO_PUS100KDOWN_CTRL  (PAD_CTL_HYS | PAD_CTL_PKE | PAD_CTL_PUE | \
				PAD_CTL_PUS_100K_DOWN | PAD_CTL_DSE_DISABLE | PAD_CTL_SRE_FAST)
...
/*Need set below pads to 1.8v */
#define MX6SL_PAD_EPDC_D10     0x0388
#define MX6SL_PAD_EPDC_D13     0x0394
#define MX6SL_PAD_EPDC_D14     0x0398
#define MX6SL_PAD_LCD_RESET    0x0520
/*I2C3*/
#define MX6SL_PAD_EPDC_SDCE2 0x03F8
#define MX6SL_PAD_EPDC_SDCE3 0x03FC
#define MX6SL_PAD_AUD_RXFS   0x02B0
#define MX6SL_PAD_AUD_RXC    0x02A8

/*Camera,data need set to 1.8V*/
#define MX6SL_PAD_SD2_CLK        0x055C
#define MX6SL_PAD_SD2_CMD      0x0560
#define MX6SL_PAD_SD2_DAT0      0x0564
#define MX6SL_PAD_SD2_DAT1      0x0568
#define MX6SL_PAD_SD2_DAT2      0x056C
#define MX6SL_PAD_SD2_DAT3      0x0570
#define MX6SL_PAD_SD2_DAT4      0x0574
#define MX6SL_PAD_SD2_DAT5       0x0578
#define MX6SL_PAD_SD2_DAT6       0x057C
#define MX6SL_PAD_SD2_DAT7       0x0580

#define MX6SL_PAD_ECSPI2_MISO	0x0368
#define MX6SL_PAD_ECSPI2_SCLK	0x0370
#define MX6SL_PAD_ECSPI2_SS0	0x0374
#define MX6SL_PAD_ECSPI2_MOSI	0x036C

/*SD4 WIFI*/
#define MX6SL_PAD_FEC_MDIO  0x0420
#define MX6SL_PAD_FEC_TX_CLK 0x0434
#define MX6SL_PAD_FEC_RX_ER  0x0428
#define MX6SL_PAD_FEC_CRS_DV 0x0418
#define MX6SL_PAD_FEC_RXD1 0x0430
#define MX6SL_PAD_FEC_TXD0 0x043C
#define MX6SL_PAD_KEY_COL6 0x048C
#define MX6SL_PAD_KEY_COL7 0x0490
...
#define MX6SL_PAD_ECSPI2_SCLK__GPIO_4_12                                      \
		IOMUX_PAD(0x0370, 0x0080, 5, 0x0000, 0,MX6SL_GPIO_PUS100KUP_CTRL/*NO_PAD_CTRL*/)
...
#define MX6SL_PAD_EPDC_D13__GPIO_1_20                                         \
		IOMUX_PAD(0x0394, 0x00A4, 5, 0x0000, 0, MX6SL_HP_DET_PAD_CTRL)
...
#define MX6SL_PAD_EPDC_PWRINT__GPIO_2_12                                      \
		IOMUX_PAD(0x03E4, 0x00F4, 5, 0x0000, 0, MX6SL_GPIO_CTRL)
...
#define MX6SL_PAD_EPDC_PWRSTAT__GPIO_2_13                                     \
		IOMUX_PAD(0x03E8, 0x00F8, 5, 0x0000, 0, MX6SL_GPIO_CTRL)
...
#define MX6SL_PAD_FEC_CRS_DV__USDHC4_DAT1_50MHZ                                     \
		IOMUX_PAD(0x0418, 0x0128, 1, 0x0860, 1, MX6SL_USDHC_PAD_CTRL)
#define MX6SL_PAD_FEC_CRS_DV__USDHC4_DAT1_100MHZ                                     \
		IOMUX_PAD(0x0418, 0x0128, 1, 0x0860, 1, MX6SL_USDHC_PAD_CTRL_100MHZ)
#define MX6SL_PAD_FEC_CRS_DV__USDHC4_DAT1_200MHZ                                     \
		IOMUX_PAD(0x0418, 0x0128, 1, 0x0860, 1, MX6SL_USDHC_PAD_CTRL_200MHZ)
...
#define MX6SL_PAD_FEC_MDIO__USDHC4_CLK_50MHZ                                        \
		IOMUX_PAD(0x0420, 0x0130, 1, 0x0850, 1, MX6SL_USDHC_PAD_CTRL)
#define MX6SL_PAD_FEC_MDIO__USDHC4_CLK_100MHZ                                        \
		IOMUX_PAD(0x0420, 0x0130, 1, 0x0850, 1, MX6SL_USDHC_PAD_CTRL_100MHZ)
#define MX6SL_PAD_FEC_MDIO__USDHC4_CLK_200MHZ                                        \
		IOMUX_PAD(0x0420, 0x0130, 1, 0x0850, 1, MX6SL_USDHC_PAD_CTRL_200MHZ)		
...
#define MX6SL_PAD_FEC_RX_ER__USDHC4_DAT0_50MHZ                                      \
		IOMUX_PAD(0x0428, 0x0138, 1, 0x085C, 1, MX6SL_USDHC_PAD_CTRL)
#define MX6SL_PAD_FEC_RX_ER__USDHC4_DAT0_100MHZ                                      \
		IOMUX_PAD(0x0428, 0x0138, 1, 0x085C, 1, MX6SL_USDHC_PAD_CTRL_100MHZ)
#define MX6SL_PAD_FEC_RX_ER__USDHC4_DAT0_200MHZ                                      \
		IOMUX_PAD(0x0428, 0x0138, 1, 0x085C, 1, MX6SL_USDHC_PAD_CTRL_200MHZ)		
...
#define MX6SL_PAD_FEC_RXD1__USDHC4_DAT2_50MHZ                                       \
		IOMUX_PAD(0x0430, 0x0140, 1, 0x0864, 1, MX6SL_USDHC_PAD_CTRL)
#define MX6SL_PAD_FEC_RXD1__USDHC4_DAT2_100MHZ                                       \
		IOMUX_PAD(0x0430, 0x0140, 1, 0x0864, 1, MX6SL_USDHC_PAD_CTRL_100MHZ)
#define MX6SL_PAD_FEC_RXD1__USDHC4_DAT2_200MHZ                                       \
		IOMUX_PAD(0x0430, 0x0140, 1, 0x0864, 1, MX6SL_USDHC_PAD_CTRL_200MHZ)
...
#define MX6SL_PAD_FEC_TX_CLK__USDHC4_CMD_50MHZ                                      \
		IOMUX_PAD(0x0434, 0x0144, 1, 0x0858, 1, MX6SL_USDHC_PAD_CTRL)
#define MX6SL_PAD_FEC_TX_CLK__USDHC4_CMD_100MHZ                                      \
		IOMUX_PAD(0x0434, 0x0144, 1, 0x0858, 1, MX6SL_USDHC_PAD_CTRL_100MHZ)
#define MX6SL_PAD_FEC_TX_CLK__USDHC4_CMD_200MHZ                                      \
		IOMUX_PAD(0x0434, 0x0144, 1, 0x0858, 1, MX6SL_USDHC_PAD_CTRL_200MHZ)		
...
#define MX6SL_PAD_FEC_TX_EN__GPIO_4_22                                        \
		IOMUX_PAD(0x0438, 0x0148, 5, 0x0000, 0, MX6SL_GPIO_PUS100KDOWN_CTRL)
...
#define MX6SL_PAD_FEC_TXD0__USDHC4_DAT3_50MHZ                                       \
		IOMUX_PAD(0x043C, 0x014C, 1, 0x0868, 1, MX6SL_USDHC_PAD_CTRL)
#define MX6SL_PAD_FEC_TXD0__USDHC4_DAT3_100MHZ                                       \
		IOMUX_PAD(0x043C, 0x014C, 1, 0x0868, 1, MX6SL_USDHC_PAD_CTRL_100MHZ)
#define MX6SL_PAD_FEC_TXD0__USDHC4_DAT3_200MHZ                                       \
		IOMUX_PAD(0x043C, 0x014C, 1, 0x0868, 1, MX6SL_USDHC_PAD_CTRL_200MHZ)		
...
#define MX6SL_PAD_FEC_TXD0__GPIO_4_24                                         \
		IOMUX_PAD(0x043C, 0x014C, 5, 0x0000, 0, MX6SL_GPIO_CTRL)
...
#define MX6SL_PAD_KEY_COL2__GPIO_3_28                                         \
		IOMUX_PAD(0x047C, 0x0174, 5, 0x0000, 0, MX6SL_GPIO_CTRL)
...
#define MX6SL_PAD_KEY_COL7__GPIO_4_6                                          \
		IOMUX_PAD(0x0490, 0x0188, 5, 0x0000, 0, NO_PAD_CTRL/*MX6SL_USDHC_PAD_CTRL*/)
...
#define MX6SL_PAD_WDOG_B__GPIO_3_18_ONOFF                               \
	        IOMUX_PAD(0x05A8, 0x02A0, 5, 0x0000, 0,                     \
				PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP |       \
				PAD_CTL_SPEED_LOW |PAD_CTL_SRE_SLOW | PAD_CTL_HYS)
