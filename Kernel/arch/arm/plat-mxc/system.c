...
{
	unsigned int wcr_enable, wcr_value;

	imx2_wdt_reboot = 0x12345678;
	...
	wcr_value = __raw_readw(wdog_base) & 0xff;
	__raw_writew(wcr_value, wdog_base);

	__raw_writew(0x5555, wdog_base+0x02);
	__raw_writew(0xaaaa, wdog_base+0x02);
